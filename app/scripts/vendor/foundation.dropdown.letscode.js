/**
 * Modification of Foundation Dropdown widget for Let's Code! specific purposes
 * See https://github.com/zurb/foundation/blob/master/LICENSE for original license
 */
;(function ($, window, document, undefined) {
  ...
  Foundation.libs.dropdown = {
    ...
    css : function (dropdown, target) {
      ...
      // Let's Code! modification - centre on parent
      ...
      if (this.small()) {
        ...
        // Let's Code! modification - this checks whether the popup is visible within the screen width but
        // it messes up the position for ours, so removing for now
        /*
